...
| <img src="../assets/members/U201912407.jpg" alt="Carlos Joel Shimabukuro Uku" width="100">| Shimabukuro Uku, Carlos Joel | U201912407 | Soy estudiante de Ingeniería de Software en la Universidad Peruana de Ciencias Aplicadas (UPC) y actualmente estoy en el octavo ciclo académico. Mi experiencia se centra principalmente en la programación orientada a objetos utilizando C++, además de tener conocimientos en HTML, CSS y JavaScript. En este proyecto, mi objetivo es aplicar los conocimientos adquiridos hasta ahora y obtener una comprensión más profunda sobre mi futuro rol como profesional en esta área. |
| <img src="../assets/members/U20211G499.jpeg" alt="Stephano Moscoso Bejar" width="100"> | Moscoso Bejar Stephano | U20211G400 | Soy un estudiante de 22 años, con gusto en crear paginas web sobretodo en Forntend y diseñar backends para el uso comercial o personal de las personas. |
