...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>Web app responsive.</td>
            <td>Web, aplicaciones móviles complementarias y red de partners locales para implementación.</td>
            <td>Web y aplicación móvil.</td>
            <td>Web y aplicaciones móviles nativas (iOS y Android).</td>
        </tr>
        <tr>
